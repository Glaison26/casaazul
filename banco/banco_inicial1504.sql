...
INSERT INTO `cadastro` (`id`, `nome`, `datanasc`, `identidade`, `cpf`, `cep`, `endereco`, `bairro`, `cidade`, `nomepai`, `nomemae`, `fone1`, `fone2`, `fone3`, `niss`, `email`, `data_cadastro`, `numerofilhos`, `sexo`, `genero`, `socio`, `datasocio`, `observacao`) VALUES
	(4, 'Glaison Queiroz', '1968-10-26', '4662097', '69551022653', '34505480', 'Rua da Intendencia 316', 'Centro', 'Sabará', 'Valdir Queiroz', 'Emilia Pereira Queiroz', '(31) 98426-2508', '(31) 3672-7688', '', '45465465', 'glaison26.queiroz@gmail.com', '2026-04-01', 0, 'M', NULL, NULL, NULL, _binary ''),
	(5, 'maria da Silva', '2005-04-13', '6464564', '4564564', '34505060', 'Praça Paulo de Souza Lima', 'Caieira', 'Sabará', '', '', '(31) 22222-2222', '', '', '', '', '2026-04-14', 0, 'F', NULL, NULL, NULL, _binary ''),
	(6, 'Lorena Carvalho', '2000-06-12', '433232233', '90377764000', '34505080', 'Rua Honorina da Silva Oliveira, 100', 'Caieira', 'Sabará', '', '', '(31) 121321-3212', '', '', '', '', '2026-04-14', 0, 'M', NULL, NULL, NULL, _binary ''),
	(7, 'Antonio da Silva', '2000-02-13', '65464646', '17828235062', '34505700', 'Rua Braúna, 1000', 'Alto do Cabral', 'Sabará', 'Glaison Queiroz', 'Glaison Queiroz', '(31) 8282-8282', '', '', '543534', 'teste@gmail.com', '2026-04-15', 1, 'M', 'M', NULL, NULL, _binary '');
...
-- Copiando dados para a tabela casaazul.dependentes: ~1 rows (aproximadamente)
INSERT INTO `dependentes` (`id`, `id_pessoa`, `nome`, `data_nasc`, `sexo`) VALUES
	(1, 7, 'Antonio JR', '2000-04-15', 'M');
