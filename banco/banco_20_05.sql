...
INSERT INTO `atividades_realizadas` (`id`, `id_curso`, `data_inicio`, `data_final`, `id_instrutor`, `num_vagas`, `carga_horaria`, `observacao`) VALUES
	...
	(6, 2, '2026-04-24', '2026-04-30', 2, 7, '48 horas', _binary 0x4f66666963652032303231);
...
-- Copiando dados para a tabela casaazul.cadastro: ~2 rows (aproximadamente)
...
-- Copiando dados para a tabela casaazul.dependentes: ~3 rows (aproximadamente)
INSERT INTO `dependentes` (`id`, `nome`, `data_nasc`, `sexo`, `id_pessoa`) VALUES
	(1, 'Glaison Jr.', '1999-08-13', 'M', 4),
	(5, 'Renan Junior', '2001-10-23', 'M', 5),
	(6, 'Simone dos Reis', '2010-01-15', 'F', 5);
...
CREATE TABLE IF NOT EXISTS `instrutores` (
  ...
  `id_parceria` int DEFAULT NULL,
  `tipo_vinculacao` varchar(80) DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Copiando dados para a tabela casaazul.instrutores: ~6 rows (aproximadamente)
INSERT INTO `instrutores` (`id`, `nome`, `cep`, `endereco`, `bairro`, `escolaridade`, `fone1`, `fone2`, `fone3`, `email`, `id_curso`, `datanasc`, `uf`, `cpf`, `identidade`, `cnpj`, `cidade`, `observacao`, `banco`, `agencia`, `conta`, `titular`, `sexo`, `tipo_conta`, `chave_pix`, `id_parceria`, `tipo_vinculacao`) VALUES
	(1, 'Renan da Silva', '34505480', 'Rua da Intendência', 'Centro', 'Ensino Superior Incompleto', '(31) 8383-8888', '', NULL, 'glisia.queiroz.adm@gmail.com', 0, '2026-01-26', 'MG', '69551022653', 'm48848', '', 'Sabará', _binary '', '', '', '', '', 'M', '', NULL, NULL, NULL),
	(2, 'José da Silva', '34505480', 'Rua da Intendência, 333', 'Centro', 'Ensino Superior Completo', '(31) 44444-4444', '', NULL, 'teste@gmail.com', 0, '1987-02-01', 'MG', '142442', '44444', '', 'Sabará', _binary '', '', '', '', '', 'M', '', '', NULL, NULL),
	(3, 'Glaison Queiroz', '34505480', 'Rua da Intendência', 'Centro', 'Ensino Médio Incompleto', '(31) 9854-5555', '', NULL, 'teste@gmail.com', 0, '2001-11-12', 'MG', '33768405044', '41234', '', 'Sabará', _binary '', '', '333', '23423423', 'Glaison', 'M', '', '3242134', NULL, NULL),
	(4, 'Antonio dos Santos Ribeiro', '34505080', 'Rua Honorina da Silva Oliveira', 'Caieira', 'Ensino Superior Incompleto', '(31) 9854-5555', '', NULL, 'teste@gmail.com', 0, '1995-10-27', 'MG', '95175143018', 'm 5757575', '', 'Sabará', _binary '', '', '', '', '', 'M', '', '', NULL, NULL),
	(5, 'Marvio Lucio', '34505170', 'Rua do Ouro, 150', 'Vila Esperança', 'Ensino Superior Incompleto', '(31) 9854-5555', '(31) 9854-5555', NULL, 'teste@gmail.com', 0, '2002-01-30', 'MG', '22994195003', '229941950', '', 'Sabará', _binary '', '', '', '', '', 'M', '', '', NULL, NULL),
	(6, 'Marcos Cezar da Cruz', '34505090', 'Rua Odilon Alves dos Santos, 122', 'Centro', 'Ensino Superior Incompleto', '(31) 939-3999', '(31) 9938-8888', NULL, 'teste@gmail.com', 0, '1996-08-25', 'MG', '48142795078', '838448884', '', 'Sabará', _binary 0x7465737465, 'Banco do Brasil', '9399-0', '83838-9', 'Marocos antonio', 'M', 'Corrente', '35432354', 2, 'Autônomo');

-- Copiando estrutura para tabela casaazul.parcerias
CREATE TABLE IF NOT EXISTS `parcerias` (
  `id` int NOT NULL AUTO_INCREMENT,
  `numero` varchar(15) DEFAULT NULL,
  `identificacao` varchar(120) DEFAULT NULL,
  `vigencia_inicio` date DEFAULT NULL,
  `vigencia_fim` date DEFAULT NULL,
  `prorrogacao_inicio` date DEFAULT NULL,
  `prorrogacao_fim` date DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Copiando dados para a tabela casaazul.parcerias: ~2 rows (aproximadamente)
INSERT INTO `parcerias` (`id`, `numero`, `identificacao`, `vigencia_inicio`, `vigencia_fim`, `prorrogacao_inicio`, `prorrogacao_fim`) VALUES
	(1, '4654654', 'Termo de Fomento', '2026-05-01', '2026-07-31', '2026-08-01', '2026-08-31'),
	(2, '66666', 'Subvenção', '2026-05-01', '2026-05-30', '2026-05-20', '2026-05-29');
...
-- Copiando dados para a tabela casaazul.participantes_acoes: ~2 rows (aproximadamente)
